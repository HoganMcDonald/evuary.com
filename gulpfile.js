// npm install --save-dev gulp browser-sync gulp-nodemon del run-sequence gulp-htmlmin gulp-rename gulp-imagemin gulp-sourcemaps gulp-babel babel-preset-env babel-core gulp-uglify gulp-sass gulp-autoprefixer gulp-clean-css gulp-concat
...
const vendorOrder = ['src/vendors/jquery.min.js', 'src/vendors/bootstrap.bundle.min.js', 'src/vendors/angular.min.js'];
...
gulp.task('vendors', ['vendors:style'], ()=> {
  gulp.src(vendorOrder)
